const locationData = {
  ...
  "Assam": [
    ...
    "Karbi Anglong", "Kokrajhar", "Majuli", "Morigaon", "Nagaon",
  ...
  "Bihar": [
    ...
    "Gaya", "Gopalganj", "Jamui", "Jehanabad", "Khagaria",
    "Kishanganj", "Kaimur", "Katihar", "Lakhisarai", "Madhepura",
  ...
  "Madhya Pradesh": [
    ...
    "Harda", "Indore", "Jabalpur", "Jhabua", "Katni",
    "Khandwa", "Khargone", "Mandla", "Mandsaur", "Morena",
    "Narmadapuram", "Narsinghpur", "Neemuch", "Niwari",
  ...
  "Punjab": [
    ...
    "Fazilka", "Ferozepur", "Gurdaspur", "Hoshiarpur",
    "Jalandhar", "Kapurthala", "Ludhiana", "Malerkotla",
  ...
  "Rajasthan": [
    ...
    "Pali", "Phalodi", "Pratapgarh", "Rajsamand", "Ramganj Mandi",
    "Salumber", "Sanchore", "Sawai Madhopur", "Shahpura",
  ...
  "Telangana": [
    ...
    "Khammam", "Komaram Bheem Asifabad", "Mahabubabad",
